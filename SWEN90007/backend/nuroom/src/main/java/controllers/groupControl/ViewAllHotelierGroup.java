...
@WebServlet("/ViewAllHotelierGroup")
public class ViewAllHotelierGroup extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (connection!=null){
            ...
            Result<List<HotelierGroup>> result=groupService.viewAllHotelierGroup();
